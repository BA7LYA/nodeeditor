///
/// @file DataFlowGraphicsScene.cxx
...
#include "DataFlowGraphicsScene.hxx"
    ...
    , _graphModel(graphModel)
{
    connect(
        ...
        [this](const NodeId nodeId, const PortType, const PortIndex)
...
QMenu* DataFlowGraphicsScene::createSceneMenu(const QPointF scenePos)
{
    ...
    connect(
        ...
        {
            QTreeWidgetItemIterator categoryIt(
                treeView,
