...
static void insertSerializedItems(
    QJsonObject const &json, BasicGraphicsScene *scene)
{
...
static void deleteSerializedItems(
    QJsonObject &sceneJson, AbstractGraphModel &graphModel)
{
...
CreateCommand::CreateCommand(
    BasicGraphicsScene *scene, QString const name, QPointF const &mouseScenePos)
    : _scene(scene)
...
PasteCommand::PasteCommand(
    BasicGraphicsScene *scene, QPointF const &mouseScenePos)
    : _scene(scene)
...
DisconnectCommand::DisconnectCommand(
    BasicGraphicsScene *scene, ConnectionId const connId)
    : _scene(scene)
    , _connId(connId)
{
    //
